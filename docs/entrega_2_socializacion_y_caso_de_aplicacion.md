...
3. **Soporte**
   ...
   **Referencias**
   ...
   6. OpenJS Foundation. (2025). *Node-RED User Guide: Working with context*. https://nodered.org/docs/user-guide/context
   7. Ferraiolo, D., Kuhn, R., & Chandramouli, R. (2007). *Role-Based Access Control* (2.ª ed.). Artech House.
